...
export interface ProductArrayInputProps {
    countString: string;
    countName: string;
    fieldString: string;
    fieldName: string;
...
export default function ProductArrayInput({ countName, fieldString, fieldName, data, startingCount = 1 }: ProductArrayInputProps): ReactNode {
